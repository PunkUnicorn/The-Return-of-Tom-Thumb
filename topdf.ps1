...
Get-Content -Path "Prose - Chapter One*.md" | python spellchecker.py | -split " " | $bits | Add-AppveyorTest -Name "Spelling" -Framework NUnit -Filename $bits[0] -Outcome $bits[1] -ErrorMessage $bits[2]
