...
Get-Content -Path "Prose - Chapter One*.md" | python spellchecker.py | %{$_.Split(" ")} | Output-String

#Add-AppveyorTest -Name "Spelling" -Framework NUnit -Filename $_[0] -Outcome $_[1] -ErrorMessage $_[2]
