...
Write-output "# Appendix Two" | Out-File "Prose - Appendix2.md" -Append
Write-output "# Appendix Three" | Out-File "Prose - Appendix3.md" -Append
Write-output "# Appendix Four" | Out-File "Prose - Appendix4.md" -Append
